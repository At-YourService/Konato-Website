...
<section class="service-content pad-bottom">
	<div class="container no-pad-right no-pad-left">
		...
		<?php endif; ?>
		<div class="row">
			<div class="col-md-12 text-left apply-content">
				<h2>We have received your application for the position of <?php if(isset($_GET['job-title'])) { echo($_GET['job-title']); } ?></h2>
					<?php if (have_posts()) : ?>
		...
		<?php
			$args = array( 'post_type' => 'freelance-job', 'posts_per_page' => 3 );
		...
		<div class="service-readmore">
			<a href="/freelance-jobs">
				<button class="info home-info">See all our jobs</button>
			</a>
		</div>
		</div>
	</div>
